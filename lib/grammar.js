var grammar = module.exports = {
  ...
  a: [
    { //a=rtpmap:110 opus/48000/2
      ...
      format: function (o) {
        var s = 'rtpmap:' + o.payload + ' ' + o.codec + '/' + o.rate;
        return (o.encoding == null) ? s : s + '/' + o.encoding;
      }
    },
    ...
    { //a=rtcp:65179 IN IP4 193.84.77.194
      ...
      format: function (o) {
        var s = 'rtcp:' + o.port;
        return (o.netType == null || o.ipVer == null || o.address == null) ?
          s : s + ' ' + o.netType + ' IP' + o.ipVer + ' ' + o.address;
      }
    },
